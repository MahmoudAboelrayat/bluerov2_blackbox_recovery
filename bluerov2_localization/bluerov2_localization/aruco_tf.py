...
class ArucoStaticTFs(Node):
    def __init__(self):
        ...
        marker_poses = [
            (4.5, 7.0, 4.8, 0.7068252, 0.7073883, 0.0000327, 0.0000328),  # Aruco 0
            (1.5, 1.0, 4.8, 0.7068252, 0.7073883, 0.0000327, 0.0000328),  # Aruco 1
            (7.5, 4.0, 4.8, 0.7068252, 0.7073883, 0.0000327, 0.0000328),  # Aruco 2
            (7.5, 7.0, 4.8, 0.7068252, 0.7073883, 0.0000327, 0.0000328),  # Aruco 3
            (4.5, 4.0, 4.8, 0.7068252, 0.7073883, 0.0000327, 0.0000328),  # Aruco 4
            (1.5, 7.0, 4.8, 0.7068252, 0.7073883, 0.0000327, 0.0000328),  # Aruco 5
            (1.5, 4.0, 4.8, 0.7068252, 0.7073883, 0.0000327, 0.0000328),  # Aruco 6
            (4.5, 1.0, 4.8, 0.7068252, 0.7073883, 0.0000327, 0.0000328),  # Aruco 7
            (7.5, 1.0, 4.8, 0.7068252, 0.7073883, 0.0000327, 0.0000328),  # Aruco 8
        ]
        transforms = []
